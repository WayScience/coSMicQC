...
def fixture_jump_cytotable_data(
    ...
    s3_result = cytotable.convert(
        ...
        joins="""
            ...
            FROM
                ...
                LIMIT 38000) AS cytoplasm
            LEFT JOIN (SELECT *
                FROM read_parquet('cells.parquet')
                LIMIT 38000) AS cells ON
    ...
    assert (parquet_file_meta.num_rows, parquet_file_meta.num_columns) == (38000, 5928)

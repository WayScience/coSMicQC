...
![_ ___coSMicQC___ enables erroneous anomaly analysis through the `label_outliers` function, which appends z-score data for features, and the `CytoDataFrame.show_report` method to visualize where outliers are detected within the dataset._](./images/cosmicqc-example-histogram.png){width=100%}
